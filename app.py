...
def main():
    ...
    parser = argparse.ArgumentParser(description="Hệ thống Multi-Agent phản ứng nhanh Kubernetes")
    parser.add_argument("--alert-file", "-f", help="File alert JSON để xử lý")
    parser.add_argument("--interactive", "-i", action="store_true", help="Chạy chế độ tương tác")
